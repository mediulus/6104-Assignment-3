...
import { TrainingRecords, User, Date } from "./training-records";
 ...
 */
export async function testNormalTrainingWeek(): Promise<void> {
  console.log("\n🧪 TEST CASE 1: Normal Training Week");
  console.log("=====================================");

  const trainingRecords = new TrainingRecords();
  ...
  // Monday - Easy run
  const mon = trainingRecords.createRecord(
    coach,
    athlete,
    weekStart,
    70,
  ...
  // Tuesday - Tempo run
  const tue = trainingRecords.createRecord(
    coach,
    athlete,
    createDate(2024, 1, 16),
    85,
    "Tempo run - 3 miles at threshold"
  );
  ...
  // Wednesday - Rest day
  const wed = trainingRecords.createRecord(
    coach,
    athlete,
  ...
  const thu = trainingRecords.createRecord(
    coach,
    athlete,
  ...
  // Friday - Medium easy
  const fri = trainingRecords.createRecord(
    coach,
    athlete,
  ...
  // Saturday - Long run
  const sat = trainingRecords.createRecord(
    coach,
    athlete,
  ...
  const sun = trainingRecords.createRecord(
    coach,
    athlete,
  ...
  try {
    const result = await trainingRecords.summarizeAndRecommend(
      athlete,
      llm,
      weekStart
    );
 ...
 */
export async function testConcerningTrends(): Promise<void> {
  ...
  const prevMon = trainingRecords.createRecord(
    coach,
    athlete,
    createDate(2024, 1, 8),
    70,
  ...
  const prevTue = trainingRecords.createRecord(
    coach,
    athlete,
    createDate(2024, 1, 9),
    80,
 ...
 */
export async function testMissingData(): Promise<void> {
